...
if (isset($_GET['delete'])) {
    ...
    if ($user_id == $_SESSION['user_id']) {
        ...
        // Check if user to be deleted is superadmin
        ...
        else if (($user_to_delete['role'] == 'superadmin') || ($user_to_delete['role'] == 'admin')  && !isSuperAdmin()) {
            $message = "Hanya Super Admin yang dapat menghapus akun Admin Lainnya.";
            $message_type = "danger";
        } else {
